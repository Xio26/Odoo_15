...
class ResPartner(models.Model):
    ...
    def fetch_ruc_data(self, vat_number):
        ...
        default_endpoint = self.env['ir.config_parameter'].sudo().get_param('odoofact_iap_endpoint', DEFAULT_IAP_ENDPOINT)
        ...
        result = iap_tools.iap_jsonrpc(iap_server_url + '/iap/get_partner_data', params=params)
