...
class ResCompany(models.Model):
    ...
    l10n_pe_api_dni_connection = fields.Selection([
        ('consul_dni_api','CONSULTA DNI API')
    ], string='Api DNI Connection', default='consul_dni_api')
    l10n_pe_api_ruc_connection = fields.Selection([
        ('consul_ruc_api','CONSULTA RUC API')
    ], string='Api RUC Connection', default='consul_ruc_api')
